                    ...
                    <div id="easy" class="container tab-pane active"><br>
                        ...
                        <form action="EasyMapRequest" method="post" accept-charset="ISO-8859-1" id="easyForm">
                            <div class="form-group">
                                ...
                                <small id="easyCurrentLocationHelp" class="form-text text-muted">Please fill in a street
                                    in Vienna!</small>
                            </div>
                            ...
                            <div class="btn-group btn-group-toggle pb-3" role="group" data-toggle="buttons"
                                ...
                                <label class="btn btn-secondary active">
                                    <input type="radio" name="transport-option" value="BIKE" id="transport-bicycle"
                                           autocomplete="off" checked> <i class="fas fa-bicycle"></i> Bicycle
                                </label>
                                <label class="btn btn-secondary">
                                    <input type="radio" name="transport-option" value="PUBLIC" id="transport-public"
                                           autocomplete="off"> <i class="fas fa-bus"></i> Public Transport
                                </label>
                                <label class="btn btn-secondary">
                                ...
                                <label class="btn btn-secondary">
                                    <input type="radio" name="transport-option" value="FOOT" id="transport-walk"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="easyDownloadSize" name="downloadSize"
                                ...
                                <small id="easyDownloadSizeHelp" class="form-text text-muted">Please fill in the size of
                                    file you want to download!</small>
                            </div>

                            <div class="btn-group btn-group-toggle pb-3" role="group" data-toggle="buttons"
                                 aria-label="transport" id="updownloadRadio" required>
                                <label class="btn btn-secondary active">
                            ...
                            <div class="form-group pt-3">
                                <button type="button" class="btn btn-primary" onclick="speedtestAndSubmitEasy();">
                                    Perform Speedtest & get my results!
                                </button>
                            </div>
                        </form>
                        <div class="pt-4">
                        ...
                        <form action="ExpertMapRequest" method="post" accept-charset="ISO-8859-1" id="expertForm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="expertCurrentLocation"
                                       name="CurrentLocation" placeholder="Current Location" required>
                            ...
                            <div class="btn-group btn-group-toggle pb-3" role="group" data-toggle="buttons"
                                 aria-label="transport" required>
                                <label class="btn btn-secondary active">
                                    <input type="radio" name="transport-option" value="BIKE"
                                           id="transport-bicycle-expert" autocomplete="off" checked> <i
                                        class="fas fa-bicycle"></i> Bicycle
                                </label>
                                <label class="btn btn-secondary active">
                                    <input type="radio" name="transport-option" value="PUBLIC"
                                           id="transport-public-expert" autocomplete="off"> <i class="fas fa-bus"></i>
                                    Public Transport
                                </label>
                                <label class="btn btn-secondary">
                                ...
                                <label class="btn btn-secondary">
                                    <input type="radio" name="transport-option" value="FOOT" id="transport-walk-expert"
                                           autocomplete="off"> <i class="fas fa-walking"></i> Walk
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="expertDownloadSize"
                                           name="downloadSize" placeholder="Filesize eg. 100 GB" required>
                                    <div class="input-group-append">
                                        <select class="browser-default custom-select" name="sizeAppend">
                                            <option value="MB">MB</option>
                                            <option value="GB" selected>GB</option>
                                ...
                                <small id="expertDownloadSizeHelp" class="form-text text-muted">Please fill in the size
                                    of file you want to download!</small>
                            </div>

                            <div class="btn-group btn-group-toggle pb-3" role="group" data-toggle="buttons"
                                 aria-label="transport" required>
                                <label class="btn btn-secondary active">
                                    <input type="radio" name="updownloadRadio" id="uploadRadio" value="upload"
                                           checkedautocomplete="off" onclick="labelUpload()" checked> <i
                                        class="fas fa-upload"></i>Upload File
                                </label>
                                <label class="btn btn-secondary">
                                    <input type="radio" name="updownloadRadio" id="downloadRadio" value="download"
                                           onclick="labelDownload()"> <i class="fas fa-download"></i> Download File
                                </label>
                            </div>
                            ...
                            <div class="btn-group btn-group-toggle pb-3" role="group" data-toggle="buttons"
                                 aria-label="transport" required>
                                <label class="btn btn-secondary active">
                                    <input type="radio" name="internetAccess" id="speedtestRadio" value="speedtest"
                                           onclick="hideSpeedform()" checked> Perform a Speedtest
                                </label>
                                <label class="btn btn-secondary">
                                    <input type="radio" name="internetAccess" id="manualInputSpeedRadio"
                                           value="speedform" onclick="showSpeedForm()"> i know my Up- & Downstreams
                                </label>
                            </div>
                            ...
                            <br/>
                            <button type="button" class="btn btn-primary" onclick="speedtestAndSubmitExpert()">Get my
                                results!
                            </button>
